...
///////////////////////////////////////////////////////
// Sparse
inline unsigned *update_flags_sparse_serial(
...
inline void BFS_kernel_sparse_serial(
				unsigned *graph_vertices,
				unsigned *graph_edges,
				unsigned *graph_degrees,
				//int *h_graph_visited,
...
void update_flags_dense_serial(
	...
	while (0 != frontier_size) {
		if (frontier_size + out_degree > dense_threshold) {
			...
			BFS_sparse_serial(
					...
					graph_degrees,
					h_graph_flags);
			new_queue = update_flags_sparse_serial(
					h_graph_queue,
					frontier_size,
					out_degree,
					graph_degrees,
...
///////////////////////////////////////////////////////
// Sparse
inline unsigned *update_flags_sparse_simd(
		unsigned *h_graph_queue,
		unsigned &_queue_size,
		unsigned &_out_degree,
		unsigned *graph_degrees,
...
//	}
//}
inline void BFS_kernel_sparse_simd(
				unsigned *graph_vertices,
				unsigned *graph_edges,
				unsigned *graph_degrees,
				unsigned *h_graph_queue,
	...
	while (0 != frontier_size) {
		if (frontier_size + out_degree > dense_threshold) {
			...
			BFS_sparse_simd(
					...
					graph_degrees,
					h_graph_flags);
			new_queue = update_flags_sparse_simd(
					h_graph_queue,
					frontier_size,
					out_degree,
					graph_degrees,
